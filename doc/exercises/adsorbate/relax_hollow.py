...
dyn = QuasiNewton(fcc, trajectory='hollow.traj')
...
print 'Energy hollow:', fcc.get_potential_energy()
print 'Al - H bond:', linalg.norm(fcc.positions[-2] - fcc.positions[-1])

## Energy hollow: -10.2477262136
## Al - H bond: 2.0313747402
