...
Band diagrams are usefull analysis tools. Read `Na_band.py`_ and try to understand what i does, then use it to construct the band diagram of bulk Na and Si. Read `plot_band.py`_ and try to understand it, then use it to plot the band diagram. 
