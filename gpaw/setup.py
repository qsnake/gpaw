...
def create_setup(symbol, xcfunc, lmax=0, nspins=1,
    ...
    return Setup(setupdata, xcfunc, lmax, nspins, type, basis)
...
class Setup:
    ...
    def __init__(self, data, xcfunc, lmax=0, nspins=1,
        ...
        #if zero_reference:
        #    self.Kc = 0.0
            # Don't overwrite self.M it since its present value is significant
        #    self.E = 0.0
        #else:
        ...
        self.xc_correction = data.get_xc_correction(rgd, xcfunc,
                                                    gcut2, lcut)
