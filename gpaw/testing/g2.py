...
molecules = {
 ...
 'CH2_s3B1d': ("Triplet methylene (CH2), C2v symm, 3-B1."                 , r"$\rm{CH}_2\rm{ }(^3B_1)$"                                   ,   93.7,  10.6953, 2.3877),
 'CH2_s1A1d': ("Singlet methylene (CH2), C2v symm, 1-A1."                 , r"$\rm{CH}_2\rm{ }(^1A_1)$"                                   ,  102.8,  10.2422, 2.3745),
       ...
       'H2O': ("Water (H2O), C2v symm."                                   , r"$\rm{H}_2\rm{O}$"                                           ,  -57.8,  13.2179, 2.3720),
        'HF': ("Hydrogen fluoride (HF), C*v symm."                        , r"$\rm{FH}$"                                                  ,  -65.1,   5.7994, 2.0733),
'SiH2_s1A1d': ("Singlet silylene (SiH2), C2v symm, 1-A1."                 , r"$\rm{SiH}_2\rm{ }(^1A_1)$"                                  ,   65.2,   7.1875, 2.3927),
'SiH2_s3B1d': ("Triplet silylene (SiH2), C2v symm, 3-B1."                 , r"$\rm{SiH}_2\rm{ }(^3B_1)$"                                  ,   86.2,   7.4203, 2.4078),
      ...
      'SiH4': ("Silane (SiH4), Td symm."                                  , r"$\rm{SiH}_4$"                                               ,    8.2,  19.2664, 2.5232),
       ...
       'HCl': ("Hydrogen chloride (HCl), C*v symm."                       , r"$\rm{ClH}$"                                                 ,  -22.1,   4.1673, 2.0739),
 ...
 'C4H6xxxxx': ("Cyclobutene (C4H6), C2v symm."                            , r"$\rm{C}_4\rm{H}_6\rm{ (cyclobutene)}$"                      ,   37.4,  53.4105, 3.0108),
    ...
    'C4H10x': ("Trans-butane (C4H10), C2h symm."                          , r"$\rm{C}_4\rm{H}_1\rm{}_0\rm{ (trans butane)}$"              ,  -30.0,  81.3980, 4.2633),
   'C4H10xx': ("Isobutane (C4H10), C3v symm."                             , r"$\rm{C}_4\rm{H}_1\rm{}_0\rm{ (isobutane)}$"                 ,  -32.1,  81.1050, 4.2282),
