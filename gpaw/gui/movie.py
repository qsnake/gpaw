...
class Movie(gtk.Window):
    def __init__(self, gui):
        ...
        self.frame_number = gtk.Adjustment(gui.frame, 0, gui.atoms.nframes - 1,
                                           1.0, 5.0)
    ...
    def click(self, button, step):
        i = max(0, min(self.gui.atoms.nframes - 1, self.gui.frame + step))
    ...
    def play(self, widget=None):
        ...
        t = int(1000 * self.time.value / (self.gui.atoms.nframes - 1))
    ...
    def step(self):
        ...
        if i == 0:
            self.direction = 1
        elif i == self.gui.atoms.nframes - 1:
            self.direction = -1
