...
parameters = {
 'H' : {'rcut': 0.9},
 'He': {'rcut': 1.5},
 'Li': {'core': '[He]',   'rcut': [2.02, 1.90],
        'vbar': ('poly', 1.83), 'rcutcomp': 2.06},
 'Be': {'core': '[He]',   'rcut': 1.5},
 'B' : {'core': '[He]',   'rcut': 1.2},
 'C' : {'core': '[He]',   'rcut': 1.2},
 'N' : {'core': '[He]',   'rcut': [1.16, 1.00, 1.08],
        'vbar': ('f', 0.93), 'rcutcomp': 1.00, 'filter': (0.54, 1.75)},
 'O' : {'core': '[He]',   'rcut': 1.4, 'filter': (0.5, 1.75)},
 'F' : {'core': '[He]',   'rcut': 1.2},
 'Ne': {'core': '[He]',   'rcut': [1.45, 1.40, 1.80],
        'vbar': ('f', 1.72), 'rcutcomp': 1.70},
 'Na': {'core': '[Ne]', 'rcut': [2.20, 2.20],
        'vbar': ('poly', 1.95), 'rcutcomp': 2.10},
 'Mg': {'core': '[He]2s', 'rcut': [1.85, 1.85, 1.85],
        'vbar': ('poly', 2.00), 'rcutcomp': 1.90},
 ...
 'Ca': {'core': '[Ne]',   'rcut': [2.10, 2.25, 1.85],
        'vbar': ('f', 2.25), 'rcutcomp': 2.20},
 'Sc': {'core': '[Ne]',   'rcut': [2.25, 2.10, 2.15],
        'vbar': ('f', 2.05), 'rcutcomp': 2.20},
 'Ti': {'core': '[Ne]', 'rcut': [2.25, 2.15, 2.09],
        'vbar': ('f', 2.29), 'rcutcomp': 2.30},
 'V' : {'core': '[Ne]',   'rcut': [2.05, 2.00, 2.00],
        'vbar': ('poly', 2.02), 'rcutcomp': 2.05},
 'Cr': {'core': '[Ne]',   'rcut': [1.98, 2.00, 1.97],
        'vbar': ('poly', 1.95), 'rcutcomp': 2.01},
 'Mn': {'core': '[Ar]',   'rcut': [2.40, 2.12, 2.06],
        'vbar': ('f', 2.10), 'rcutcomp': 2.15},
 'Fe': {'core': '[Ar]',   'rcut': [2.35, 2.40, 2.00],
        'vbar': ('f', 2.05), 'rcutcomp': 2.15},
 'Co': {'core': '[Ar]',   'rcut': [2.40, 2.40, 2.00],
        'vbar': ('f', 2.07), 'rcutcomp': 2.15},
 'Ni': {'core': '[Ar]',   'rcut': [2.15, 2.33, 1.95],
        'vbar': ('f', 2.03), 'rcutcomp': 2.13},
 'Cu': {'core': '[Ar]',   'rcut': [2.14, 2.47, 1.95],
        'vbar': ('f', 1.98), 'rcutcomp': 2.17},
 'Zn': {'core': '[Ar]',   'rcut': [2.20, 2.20, 2.00],
        'vbar': ('f', 2.02), 'rcutcomp': 2.10},
 'Ga': {'core': '[Ar]',   'rcut': [2.25, 2.20, 2.27],
        'vbar': ('f', 2.15), 'rcutcomp': 2.35},
 'Ge': {'core': '[Ar]3d', 'rcut': [2.33, 2.46, 2.30],
        'vbar': ('f', 2.30), 'rcutcomp': 2.32},
 'As': {'core': '[Ar]3d', 'rcut': [2.20, 2.20, 2.30],
        'vbar': ('f', 2.25), 'rcutcomp': 2.30},
 'Se': {'core': '[Ar]3d', 'rcut': [2.20, 2.20, 2.20],
        'vbar': ('f', 1.95), 'rcutcomp': 2.20},
 'Br': {'core': '[Ar]3d', 'rcut': [2.20, 2.20, 2.20],
        'vbar': ('f', 2.10), 'rcutcomp': 2.20},
 'Kr': {'core': '[Ar]3d', 'rcut': [2.40, 2.55, 2.45],
        'vbar': ('f', 2.25), 'rcutcomp': 2.55},
 'Rb': {'core': '[Ar]3d', 'rcut': [2.45, 2.48, 2.35],
        'vbar': ('f', 2.13), 'rcutcomp': 2.40},
 'Sr': {'core': '[Ar]3d', 'rcut': [2.40, 2.45, 2.40],
        'vbar': ('f', 2.42), 'rcutcomp': 2.40},
 'Y':  {'core': '[Ar]3d', 'rcut': [2.52, 2.20, 2.50],
        'vbar': ('f', 2.09), 'rcutcomp': 2.25},
 'Zr': {'core': '[Ar]3d', 'rcut': [2.37, 2.20, 2.20],
        'vbar': ('f', 2.03), 'rcutcomp': 2.20},
 'Nb': {'core': '[Kr]',   'rcut': [2.77, 2.90, 2.80],
        'vbar': ('f', 2.74), 'rcutcomp': 2.80},
 'Mo': {'core': '[Kr]',   'rcut': [2.70, 2.72, 2.74],
        'vbar': ('poly', 2.28), 'rcutcomp': 2.34},
#'Tc': Radioactive
# 'Ru': {'core': '[Kr]',   'rcut': [2.50, 2.50, 2.40],
#        'vbar': ('f', 2.44), 'rcutcomp': 2.48},
 'Ru': {'core': '[Kr]',   'rcut': [2.47, 2.57, 2.43, 2.38],
        'extra':{0: [0.8], 1: [0.8], 2: [0.8], 3: [0.5]},
        'vbar': ('poly', 2.30), 'rcutcomp': 2.26},
 'Rh': {'core': '[Kr]',   'rcut': 2.5},
 'Pd': {'core': '[Kr]', 'rcut': [2.35, 2.40, 2.25],
        'vbar': ('f', 2.25), 'rcutcomp': 2.30},
 'Ag': {'core': '[Kr]',   'rcut': [2.20, 2.40, 2.12],
        'vbar': ('f', 2.15), 'rcutcomp': 2.15},
 'Cd': {'core': '[Kr]',   'rcut': [2.25, 2.30, 2.30],
        'vbar': ('f', 2.35), 'rcutcomp': 2.30},
 'In': {'core': '[Kr]',   'rcut': [2.50, 2.35, 2.30],
        'vbar': ('f', 2.20), 'rcutcomp': 2.41},
 'Sn': {'core': '[Kr]',   'rcut': [2.25, 2.35, 2.10],
        'vbar': ('f', 2.20), 'rcutcomp': 2.30},
 'Te': {'core': '[Kr]',   'rcut': [2.21, 2.15, 2.06],
        'vbar': ('poly', 2.12), 'rcutcomp': 2.12},
 'Sb': {'core': '[Kr]',   'rcut': [2.10, 2.12, 2.00],
        'vbar': ('f', 2.15), 'rcutcomp': 2.10},
 'I' : {'core': '[Kr]4d', 'rcut': [2.25, 2.20, 2.20],
        'vbar': ('f', 2.15), 'rcutcomp': 2.20},
 'Xe' : {'core': '[Kr]4d', 'rcut': [2.20, 2.20, 2.14],
        'vbar': ('f', 2.05), 'rcutcomp': 2.07},
 'Cs': {'core': '[Kr]4d', 'rcut': [2.47, 2.77, 2.69],
        'vbar': ('f', 2.23), 'rcutcomp': 2.57},
 'Ba': {'core': '[Kr]4d', 'rcut': [2.61, 2.60, 2.30],
        'vbar': ('poly', 2.20), 'rcutcomp': 2.51},
 'La': {'core': '[Kr]4d', 'rcut': [2.50, 2.75, 2.55],
        'vbar': ('poly', 1.95), 'rcutcomp': 2.21},
# 'La': {'core': '[Kr]4d5s', 'rcut': [2.3, 2.0, 1.9]},
 'Lu': {'core': '[Xe]4f', 'rcut': [2.82, 3.05, 2.51],
        'vbar': ('f', 2.54), 'rcutcomp': 2.61},
 'Hf': {'core': '[Xe]4f', 'rcut': [2.77, 2.95, 2.64],
        'vbar': ('poly', 2.41), 'rcutcomp': 2.50},
 'Ta': {'core': '[Xe]4f', 'rcut': [2.75, 2.88, 2.55],
        'vbar': ('f', 2.55), 'rcutcomp': 2.50},
 'W' : {'core': '[Xe]4f', 'rcut': [2.75, 2.78, 2.54],
        'vbar': ('f', 2.50), 'rcutcomp': 2.54},
 'Re': {'core': '[Xe]4f', 'rcut': [2.70, 2.80, 2.70],
        'vbar': ('f', 2.40), 'rcutcomp': 2.55},
 'Os': {'core': '[Xe]4f', 'rcut': [2.50, 2.64, 2.73],
        'vbar': ('f', 2.38), 'rcutcomp': 2.40},
 'Ir': {'core': '[Xe]4f', 'rcut': [2.61, 2.70, 2.63],
        'vbar': ('f', 2.48), 'rcutcomp': 2.64},
 'Pt': {'core': '[Xe]4f', 'rcut': [2.55, 2.70, 2.60],
        'vbar': ('f', 2.45), 'rcutcomp': 2.50},
 'Au': {'core': '[Xe]4f', 'rcut': [2.60, 2.55, 2.30],
        'vbar': ('f', 2.30), 'rcutcomp': 2.30},
 'Hg': {'core': '[Xe]4f', 'rcut': [2.60, 2.65, 2.64],
        'vbar': ('f', 2.64), 'rcutcomp': 2.64},
 'Tl': {'core': '[Xe]4f', 'rcut': [2.44, 2.58, 2.32],
        'vbar': ('f', 2.30), 'rcutcomp': 2.42},
 'Pb': {'core': '[Xe]4f', 'rcut': [2.45, 2.45, 2.30],
        'vbar': ('f', 2.10), 'rcutcomp': 2.30},
 'Bi': {'core': '[Xe]4f', 'rcut': [2.50, 2.50, 2.20],
        'vbar': ('f', 2.40), 'rcutcomp': 2.40},
#'Po': Missing
#'At': Missing
#'Rn': Missing
 }
