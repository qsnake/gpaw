...
void bmgs_pastep(const double* a, const int n[3],
		double* b, const int m[3], const int c[3]);
void bmgs_rotate(int layers, const int size[3],
		 double* a, const int sizea[3], const int starta[3]);
...
void bmgs_pastepz(const double_complex* a, const int n[3],
		  double_complex* b, const int m[3],
		  const int c[3]);
void bmgs_rotatez(int layers, const int size[3],
		  double_complex* a, const int sizea[3], const int starta[3]);
