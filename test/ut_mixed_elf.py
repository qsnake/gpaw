...
class UTMixedBCSetup_ELF(UTMixedBCSetup):
    """
    ...
    def setUp(self):
        name_old,self.name = self.name,UTMixedBCSetup.name
        UTMixedBCSetup.setUp(self)
        self.name = name_old
