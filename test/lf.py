...
from gridpaw.localized_functions import LocFuncs, LocFuncBroadcaster
...
p = [LocFuncs([s], gd, (0.5, 0.5, 0.25 + 0.25 * i), npts=0, lfbc=lfbc)
     for i in [0, 1, 2]]
lfbc.broadcast()
...
p = [LocFuncs([s], gd, (0.75, 0.25, 0.25 * i), npts=0)
     for i in [0, 1, 2]]
a[:] = 0.0
for q in p:
    q.add(a, c)
