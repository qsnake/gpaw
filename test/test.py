...
if len(tests) == 0:
    ...
    tests = ['lapack.py', 'setups.py', 'xc.py', 'xcfunc.py', 'gradient.py', 'pbe-pw91.py', 'cg2.py', 'd2Excdn2.py', 'test_dot.py', 'gp2.py', 'non-periodic.py', 'lf.py', 'lxc_xc.py', 'Gauss.py', 'cluster.py', 'integral4.py', 'transformations.py', 'pbc.py', 'poisson.py', 'XC2.py', 'XC2Spin.py', 'multipoletest.py', 'aedensity.py', 'proton.py', 'coulomb.py', 'ase3k.py', 'eed.py', 'timing.py', 'gauss_func.py', 'xcatom.py', 'parallel/overlap.py', 'mixer.py', 'mixer_broydn.py', 'ylexpand.py', 'wfs_io.py', 'restart.py', 'gga-atom.py', 'nonselfconsistentLDA.py', 'bee1.py', 'refine.py', 'revPBE.py', 'lrtddft2.py', 'nonselfconsistent.py', 'stdout.py', 'ewald.py', 'spinpol.py', 'plt.py', 'parallel/hamiltonian.py', 'bulk.py', 'restart2.py', 'hydrogen.py', 'H-force.py', 'CL_minus.py', 'gemm.py', 'fermilevel.py', 'degeneracy.py', 'h2o-xas.py', 'si.py', 'asewannier.py', 'vdw/quick.py', 'lxc_xcatom.py', 'davidson.py', 'cg.py', 'h2o-xas-recursion.py', 'atomize.py', 'lrtddft.py', 'lcao_force.py', 'wannier-ethylene.py', 'CH4.py', 'apmb.py', 'relax.py', 'ldos.py', 'lcao_bulk.py', 'revPBE_Li.py', 'fixmom.py', 'generatesetups.py', 'td_na2.py', 'exx_coarse.py', '2Al.py', 'si-xas.py', 'tpss.py', '8Si.py', 'transport.py', 'Cu.py', 'lcao_h2o.py', 'IP-oxygen.py', 'exx.py', 'dscf_CO.py', 'h2o_dks.py', 'H2Al110.py', 'ltt.py', 'vdw/ar2.py', 'mgga_restart.py']
